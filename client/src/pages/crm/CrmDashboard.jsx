    ...
    <CrmLayout>
      <div className="py-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            <div>
              <TaskCompletionChart data={charts.taskCompletion} isLoading={isLoading} />
            </div>
            <div>
              <LeadStatusChart data={charts.leadConversion} isLoading={isLoading} />
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            {/* Top Performers */}
            <div>
              <TopPerformers data={charts.userPerformance} isLoading={isLoading} />
            </div>
          </div>
            ...
            <div className="mt-8 bg-white rounded-lg shadow p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="bg-blue-50 rounded-lg p-4">
                  <h4 className="text-sm font-medium text-blue-900 mb-2">Deal Analytics</h4>
                  <div className="space-y-1 text-sm text-blue-700">
                    <p>Total Value: ${dashboardData.analytics.deals.totalValue?.toLocaleString() || 0}</p>
                    <p>Won Value: ${dashboardData.analytics.deals.wonValue?.toLocaleString() || 0}</p>
                    <p>Open Value: ${dashboardData.analytics.deals.openValue?.toLocaleString() || 0}</p>
                    <p>Win Rate: {dashboardData.analytics.deals.wonCount && dashboardData.analytics.deals.totalCount ? 
                      Math.round((dashboardData.analytics.deals.wonCount / dashboardData.analytics.deals.totalCount) * 100) : 0}%
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-green-50 rounded-lg p-4">
                  <h4 className="text-sm font-medium text-green-900 mb-2">Task Analytics</h4>
                  <div className="space-y-1 text-sm text-green-700">
                    <p>Total Tasks: {dashboardData.analytics.tasks.total || 0}</p>
                    <p>Completed: {dashboardData.analytics.tasks.completed || 0}</p>
                    <p>In Progress: {dashboardData.analytics.tasks.inProgress || 0}</p>
                ...
                <div className="bg-orange-50 rounded-lg p-4">
                  <h4 className="text-sm font-medium text-orange-900 mb-2">Lead Analytics</h4>
                  <div className="space-y-1 text-sm text-orange-700">
                    <p>Total Leads: {dashboardData.analytics.leads.total || 0}</p>
                    <p>New: {dashboardData.analytics.leads.new || 0}</p>
                    <p>Qualified: {dashboardData.analytics.leads.qualified || 0}</p>
                    <p>Disqualified: {dashboardData.analytics.leads.disqualified || 0}</p>
                  </div>
                </div>

                {/* Customer Analytics */}
                <div className="bg-purple-50 rounded-lg p-4">
                  <h4 className="text-sm font-medium text-purple-900 mb-2">Customer Analytics</h4>
                  <div className="space-y-1 text-sm text-purple-700">
                    <p>Total Customers: {dashboardData.analytics.customers.total || 0}</p>
                    <p>Active: {dashboardData.analytics.customers.active || 0}</p>
                    <p>Inactive: {dashboardData.analytics.customers.inactive || 0}</p>
                    <p>Archived: {dashboardData.analytics.customers.archived || 0}</p>
                  </div>
                  </div>
              </div>
            </div>
