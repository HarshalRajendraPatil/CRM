  ...
  return (
    ...
    >
      ...
      <div className="col-span-2">
        ...
        <div className="text-xs text-gray-500">{probability}% probability</div>
      </div>
      ...
      <div className="col-span-2">
        ...
        <div className="text-xs text-gray-500">
          {expectedCloseDate && getDaysUntilClose(expectedCloseDate) > 0
            ? `${getDaysUntilClose(expectedCloseDate)} days until close`
            : "Overdue by " +
              Math.abs(getDaysUntilClose(expectedCloseDate)) +
              " days"}
        </div>
      </div>
