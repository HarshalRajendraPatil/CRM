...
import { updateProject, reset } from '../../store/projectSlice';
import Input from '../../components/ui/Input';
import Button from '../../components/ui/Button';
import Alert from '../../components/ui/Alert';

const EditProjectSidebar = ({ isOpen, onClose, project }) => {
  ...
  const { isLoading, isSuccess, isError, message } = useSelector((state) => state.projects);
      ...
      <div className="h-full flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-6">
          <form onSubmit={handleSubmit}>
            ...
            {isSuccess && <Alert variant="success" message="Project updated successfully!" className="mb-4" />}
