...
import { createStage, reset } from '../../../store/projectSlice';
import Input from '../../../components/ui/Input';
import Button from '../../../components/ui/Button';
import Alert from '../../../components/ui/Alert';

const CreateStageSidebar = ({ projectId, pipelineId, onClose }) => {
          ...
          <div className="relative w-screen max-w-md">
            <div className="h-full flex flex-col bg-white shadow-xl overflow-y-auto">
              ...
              <div className="flex justify-between items-center px-6 py-4 border-b">
                <h2 className="text-xl font-semibold text-gray-800">Add New Stage</h2>
                <button
                  onClick={onClose}
              ...
              <div className="flex-1 overflow-y-auto p-6">
                <form onSubmit={handleSubmit}>
                  ...
                  {isSuccess && <Alert variant="success" message="Stage created successfully!" className="mb-4" />}
...
export default CreateStageSidebar;